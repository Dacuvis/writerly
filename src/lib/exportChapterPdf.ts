...
export async function exportChapterPdf(chapter: ChapterPdf, manuscriptTitle: string) {
  ...
  printable.querySelectorAll("h1, h2, h3, h4, h5, h6").forEach((element) => { element.setAttribute("style", "font-family:'Playfair Display',Georgia,serif;line-height:1.2;margin:0 0 22px;"); });
